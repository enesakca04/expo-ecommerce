      ...
      <SafeScreen>
        ...
        >
            ...
            <View className='bg-surface rounded-3xl p-6'>
              <View className='flex-row items-center'>
                <View className='relative'>
                  <Image source={user?.imageUrl} style={{width:80, height:80,borderRadius:40}}  transition={200}/>
          ...
          <View className=' mb-3 mx-6 bg-surface rounded-2xl p-4'>
            <TouchableOpacity
            className='flex-row items-center justify-between py-2' activeOpacity={0.7}>
              <View className='flex-row items-center'>
