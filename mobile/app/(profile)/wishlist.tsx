    ...
    <SafeScreen>
        ...
        {wishlist.length===0 ? (
            <View className='flex-1 items-center justify-center px-6'>
                ...
                <Text className='text-text-primary text-center mt-2'>Your wishlist is empty</Text>
                <Text className='text-text-secondary text-center mt-2'>Start adding products love!</Text>
                <TouchableOpacity className='bg-primary rounded-2xl px-8 py-4 mt-6' activeOpacity={0.8} onPress={() => router.push("/(tabs)")}>
                    ...
                    {wishlist.map((item) =>(
                        ...
                        >
                            <View className='flex-row p-4'>
                                <Image source={item.images[0]} className=' rounded-2xl bg-background-lighter' style={{width:96,height:96,borderRadius:8}}/>
                                ...
                                <TouchableOpacity className='self-start bg-red-500/20 p-2 rounded-full'
                                activeOpacity={0.7}
                            ...
                            {item.stock >0 && (
                                <View className='px-4 pb-4'>
                                    <TouchableOpacity className='bg-primary rounded-xl py-3 items-center' activeOpacity={0.8}
