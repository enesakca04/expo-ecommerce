  ...
  const renderProduct = ({item:product}:{item:Product}) =>(
    ...
    >
      ...
      <View className='p-3'>
        ...
        <Text className="text-text-primary font-bold text-sm mb-2" numberOfLines={2}>{product.name}</Text>
        ...
        <View className="flex-row items-center justify-between">
          <Text className="text-primary font-bold text-lg">${Number(product.price || 0).toFixed(2)}</Text>

          <TouchableOpacity className="bg-primary rounded-full size-8 items-center justify-center"
          activeOpacity={0.7}
