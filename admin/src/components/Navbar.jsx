...
import { ClipboardIcon, HomeIcon, PanelLeftIcon, ShoppingBagIcon, UsersIcon } from "lucide-react"
...
export const NAVIGATION =[
    ...
    {name: "Orders", path:"/orders",icon:<ClipboardIcon className="size-5"/>},
...
function Navbar() {
    ...
    return <div className="navbar w-full bg-base-300">
